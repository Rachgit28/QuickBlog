...
const Blog = () => {
  ...
  return data ? (
    <div className='relative'>
      <img src={assets.gradientBackground} alt="gradientbackground" className='absolute -top-50 -z-1 opacity-60' />
      <Navbar />
        ...
        <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
          ...
          <div className='my-24 max-w-3xl mx-auto'>
            ...
            <div className='flex cursor-pointer'>
              <img src={assets.facebook_icon} width={50} alt="facebookicon" />
              <img src={assets.twitter_icon} width={50} alt="facebookicon" />
              <img src={assets.googleplus_icon} width={50} alt="facebookicon" />
            </div>
          </div>
        </div>
        <Footer />
